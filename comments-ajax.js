...
var edit_mode = '1', // 再编辑模式 ( '1'=开; '0'=关 )
    ...
    pic_sb = wp_url + 'wp-content/themes/BYMT/images/loading.gif', // 提交 icon
    pic_no = wp_url + 'wp-content/themes/BYMT/images/error.png', // 错误 icon
    pic_ys = wp_url + 'wp-content/themes/BYMT/images/ok.png', // 成功 icon
    txt1 = '<div id="loading"><img src="' + pic_sb + '" style="vertical-align:middle;margin-bottom: 3px;" alt=""/> 正在努力提交，请稍候啊请稍候……</div>',
    ...
    $('#commentform').submit(function() {
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                ok_htm = '\n<span style="margin-left:70px" id="success_' + num + txt3;
                if (edit_mode == '1') {
