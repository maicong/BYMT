    ...
    <div id="index_content">
        <?php if (have_posts()) : ?>
            ...
            <div class="excerpt">
				...
				<div class="info">
					<?php if($options['postauthor']) : ?><span class="pauthor"><?php the_author() ?></span><?php endif; ?>
					...
					<?php if($options['thumbnail']) : ?><?php include('includes/thumbnail.php'); ?><?php endif; ?>
				<div class="entry">
					<?php echo mb_strimwidth(strip_tags(apply_filters('the_content', $post->post_content)), 0, 400,"...",'utf-8'); ?>
				</div>
				<div class="clear"></div>
				<div class="tagandmore">
					<?php if($options['txttag']): ?><?php BYMT_tags(); ?><?php endif; ?>
